...
```bash
# Apply migrations via Studio UI or psql
# Then deploy Eryxon Flow pointing to your self-hosted instance
...
Need help with complex deployments? Contact [office@sheetmetalconnect.com](mailto:office@sheetmetalconnect.com) for consulting services.
