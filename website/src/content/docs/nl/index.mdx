...
<Section title="Huidige <span class='text-primary'>Status</span>" description="v0.5.0 is de laatste release met actieve ontwikkeling.">
<Grid columns={3}>
  <Card title="Stabiele Release" icon="seti:tag" iconColor="#38bdf8">
    v0.5.0 is op 6 mei 2026 gepubliceerd als huidige stabiele release voor planningintegratie en shopfloor-uitvoering.
  </Card>
