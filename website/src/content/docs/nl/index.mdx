...
description: Manufacturing Execution System voor Job Shops. Open source (Apache 2.0), self-hostable, API-first. v0.6 installeer je als desktop-PWA; native Android- en iOS-apps zijn in ontwikkeling op de publieke roadmap.
template: splash
hero:
  title: |
...
<Section title="Eén Platform, <span class='text-primary'>Elk Scherm</span>" description="Van het kantoortablet tot het werkvloer-terminal — Eryxon Flow draait daar waar je team werkt. v0.6 is stabiel en installeer je als desktop-PWA; native mobile apps zijn in ontwikkeling op de roadmap.">
<Grid columns={4}>
  <Card title="Web App + PWA" icon="seti:globe" iconColor="#fbbf24" size="sm">
    **Stabiel (v0.6).** Tablet-vriendelijke responsive web-app die je als desktop-PWA installeert vanuit Chrome of Edge. Real-time updates via WebSockets. Hosted versie gratis te proberen.
  </Card>
  <Card title="Android (Native)" icon="seti:mobile" iconColor="#34d399" size="sm">
    **In ontwikkeling.** Native Android-app met **offline-ondersteuning** en **snel opstarten**, voor robuuste tablets en telefoons. Volg het op de [publieke roadmap](/nl/roadmap/).
  </Card>
  <Card title="iOS" icon="seti:mobile" iconColor="#a78bfa" size="sm">
    **In ontwikkeling.** Native iPhone- en iPad-app voor managers en operators op Apple-apparaten. Volg het op de [publieke roadmap](/nl/roadmap/).
  </Card>
...
<Section title="Huidige <span class='text-primary'>Status</span>" description="v0.6 is de stabiele lijn en installeer je als desktop-PWA. MCP is live; native mobile apps zijn in ontwikkeling op de roadmap.">
<Grid columns={3}>
  <Card title="Stabiele Release" icon="seti:tag" iconColor="#38bdf8">
    **v0.6** is de huidige stabiele release en installeer je als desktop-PWA vanuit Chrome of Edge. Het bouwt voort op de v0.5.x-lijn — planning-adapters, MCP-HTTP-transport en MQTT-versterking.
  </Card>
  <Card title="Hosted Versie" icon="seti:globe" iconColor="#fbbf24">
  ...
  <Card title="Native Apps In Ontwikkeling" icon="seti:mobile" iconColor="#34d399">
    Native **Android**-app (offline-ondersteuning, snel opstarten) en **iOS**-app zijn in ontwikkeling — volg ze op de [publieke roadmap](/nl/roadmap/). De web-app en PWA zijn vandaag het primaire oppervlak.
  </Card>
</Grid>
</Section>
