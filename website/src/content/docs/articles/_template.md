...
#   3. Fill in title + description, write the body, delete these comment lines.
#   4. The article appears automatically in the Articles sidebar group and at /articles/ — no config edits.
#
