...
description: Eryxon Flow is now framed around Apache 2.0, which gives job shops a simpler answer on self-hosting, forking, and rollout control while keeping hosted and managed deployment help available as services.
head:
  - tag: meta
    attrs:
      property: og:image
