...
<Section title="Aktueller <span class='text-primary'>Status</span>" description="v0.5.0 ist die letzte Release mit aktiver Entwicklung.">
<Grid columns={3}>
  <Card title="Stabile Release" icon="seti:tag" iconColor="#38bdf8">
    v0.5.0 wurde am 6. Mai 2026 als aktuelle stabile Release für Planungsintegration und Werkstattausführung veröffentlicht.
  </Card>
