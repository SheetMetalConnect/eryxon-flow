...
<Section title="Eine Plattform, <span class='text-primary'>jeder Bildschirm</span>" description="Vom Bürotablet bis zum Werkstatt-Terminal — Eryxon Flow läuft dort, wo Ihr Team arbeitet.">
<Grid columns={4}>
  <Card title="Web-App + PWA" icon="seti:globe" iconColor="#fbbf24" size="sm">
    Tabletfreundliche, responsive Web-App, die sich aus Chrome oder Edge als Desktop-PWA installiert. Echtzeit-Updates über WebSockets. Gehostete Version kostenlos testbar.
  </Card>
  <Card title="Android (Nativ)" icon="seti:mobile" iconColor="#34d399" size="sm">
    Native Android-App mit **Offline-Unterstützung** und **schnellem Start**, für robuste Tablets und Smartphones. Verfolgen Sie sie auf der [öffentlichen Roadmap](/de/roadmap/).
  </Card>
  <Card title="iOS" icon="seti:mobile" iconColor="#a78bfa" size="sm">
    Native iPhone- und iPad-App für Manager und Werker auf Apple-Geräten. Verfolgen Sie sie auf der [öffentlichen Roadmap](/de/roadmap/).
  </Card>
  <Card title="MCP · REST · MQTT" icon="seti:json" iconColor="#fb923c" size="sm">
    MCP-Server, REST-API, Webhooks und MQTT für KI, Automatisierung und ERP-Integration. 24 REST-Endpunkte.
  </Card>
</Grid>
</Section>
