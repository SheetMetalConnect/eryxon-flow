...
description: Manufacturing Execution System für Lohnfertiger. Open Source (Apache 2.0), self-hostbar, API-first. Installiert sich als Desktop-PWA; native Android- und iOS-Apps sind in Entwicklung auf der öffentlichen Roadmap.
template: splash
hero:
  title: |
