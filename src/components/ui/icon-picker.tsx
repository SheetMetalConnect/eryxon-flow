...
import { Factory, Wrench, Hammer, Settings, Cog, Drill, Ruler, Boxes, Package, Container, Truck, Warehouse, HardHat, PlayCircle, PauseCircle, StopCircle, CheckCircle, CheckCircle2, XCircle, AlertCircle, AlertTriangle, Clock, Timer, Hourglass, RefreshCw, RotateCw, ArrowRight, ArrowLeft, TrendingUp, Plus, Minus, Edit, Trash2, Save, Copy, Download, Upload, Send, Share2, Link, Unlink, Eye, EyeOff, Lock, Unlock, Folder, FolderOpen, File, FileText, ClipboardList, ListChecks, Calendar, CalendarDays, MapPin, Tag, Tags, Bookmark, User, Users, UserCheck, UserPlus, UserMinus, UserCircle, Shield, ShieldCheck, Award, Star, Cpu, HardDrive, Server, Database, Cloud, Wifi, Radio, Bluetooth, Usb, Power, Battery, BatteryCharging, Search, ScanSearch, CheckSquare, Square, SquareCheck, CircleDot, Target, Crosshair, Microscope, FlaskConical, BarChart, BarChart2, BarChart3, LineChart, PieChart, Activity, Gauge, Signal, Home, Building, Building2, Briefcase, Package2, ShoppingCart, Layers, Grid3x3, LayoutGrid, LayoutList, Box } from "lucide-react";
...
export const ICON_CATEGORIES = {
  ...
  "Common": [
    ...
    "Layers", "Grid3x3", "LayoutGrid", "LayoutList", "Box",
  ],
} as const;

const icons: Record<string, React.ComponentType<{ className?: string }>> = { Factory, Wrench, Hammer, Settings, Cog, Drill, Ruler, Boxes, Package, Container, Truck, Warehouse, HardHat, PlayCircle, PauseCircle, StopCircle, CheckCircle, CheckCircle2, XCircle, AlertCircle, AlertTriangle, Clock, Timer, Hourglass, RefreshCw, RotateCw, ArrowRight, ArrowLeft, TrendingUp, Plus, Minus, Edit, Trash2, Save, Copy, Download, Upload, Send, Share2, Link, Unlink, Eye, EyeOff, Lock, Unlock, Folder, FolderOpen, File, FileText, ClipboardList, ListChecks, Calendar, CalendarDays, MapPin, Tag, Tags, Bookmark, User, Users, UserCheck, UserPlus, UserMinus, UserCircle, Shield, ShieldCheck, Award, Star, Cpu, HardDrive, Server, Database, Cloud, Wifi, Radio, Bluetooth, Usb, Power, Battery, BatteryCharging, Search, ScanSearch, CheckSquare, Square, SquareCheck, CircleDot, Target, Crosshair, Microscope, FlaskConical, BarChart, BarChart2, BarChart3, LineChart, PieChart, Activity, Gauge, Signal, Home, Building, Building2, Briefcase, Package2, ShoppingCart, Layers, Grid3x3, LayoutGrid, LayoutList, Box };
