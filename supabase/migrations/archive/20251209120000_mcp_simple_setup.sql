...
-- ============================================================================
-- Drop old complex tables if they exist (cleanup)
-- ============================================================================

-- We keep the old tables for now in case there's data, but the new system uses mcp_endpoints
-- The old UI pages can be deprecated in favor of the new simple setup page
