...
<body>
  <div class="container">
    <div class="header">
      <h1 style="margin: 0; font-size: 24px;">New Signup</h1>
      <p style="margin: 8px 0 0 0; opacity: 0.9;">A new company has signed up for Eryxon Flow</p>
    </div>
    <div class="content">
      <div class="info-row">
      ...
      <div class="info-row">
        ...
        <div class="value">${tenant.plan || "free"} (${tenant.status || "trial"})</div>
      </div>
      <div class="info-row">
    ...
    const emailResponse = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        from: "Eryxon Flow <noreply@send.eryxon.eu>",
        to: [ADMIN_EMAIL],
